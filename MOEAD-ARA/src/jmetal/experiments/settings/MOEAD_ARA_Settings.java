...
import MOEAD_ARA.MOEAD_ARA;

/**
 * Settings class of algorithm MOEA/D
 */
public class MOEAD_ARA_Settings extends Settings {
  public double CR_ ;
  public double F_  ;
   ...
   * Constructor
   */
  public MOEAD_ARA_Settings(String problem) {
    super(problem);
   ...
   // dataDirectory_ =  "/Users/antelverde/Softw/pruebas/data/MOEAD_parameters/Weight" ;
    ...
    dataDirectory_ =  curDir+"/DirectionVector" ;
  } // MOEAD_Settings
  ...
  public Algorithm configure() throws JMException {
    ...
    algorithm = new MOEAD_ARA(problem_);
