...
public abstract class Experiment {
  ...
  //        os.write("\\cellcolor{gray25}");
      ...
      /*  m = String.format(Locale.ENGLISH, "%10.2e", mean[indicator][i][j]);
        ...
        s = String.format(Locale.ENGLISH, "%8.2E", stdDev[indicator][i][j]);
    //    os.write("$" + m + "(" + s + ")$ & ");
        os.write( m + "(" + s + ") & ");
      }
     ...
     /* m = String.format(Locale.ENGLISH, "%10.2e", mean[indicator][i][algorithmNameList_.length - 1]);
      ...
      m = String.format(Locale.ENGLISH, "%10.3E", mean[indicator][i][algorithmNameList_.length - 1]);
      s = String.format(Locale.ENGLISH, "%8.2E", stdDev[indicator][i][algorithmNameList_.length - 1]);
    //  os.write("$" + m + "(" + s + ") $ \\\\" + "\n");
      os.write( m + "(" + s + ") \\\\" + "\n");
