 ...
 */
public class jMetalExperiment_old extends Experiment {
  ...
  public void algorithmSettings(String problemName, 
    ...
    try {
     ...
     // algorithm[1] = new MOEAD_ARA_angle_new_Settings(problemName).configure(parameters[1]); 
      ...
      Logger.getLogger(jMetalExperiment_old.class.getName()).log(Level.SEVERE, null, ex);
  ...
  public static void main(String[] args) throws JMException, IOException {
    jMetalExperiment_old exp = new jMetalExperiment_old();
    ...
    exp.algorithmNameList_ = new String[]{"MOEADARA","MOEADAGR","MOEADMRDL","MOEADIR","MOEADACD","MOEADDRA","MOEAD"};
    //exp.algorithmNameList_ = new String[]{"SMPSOhvRandomArchive"};
    //    "PAES", "PAEShv"};
        //"SMSEMOA", "SMPSO", "SMPSOhv2"};
    //"SMPSOCell2"};
    exp.problemList_ = new String[]{"MOP1", "MOP2", "MOP3", "MOP4", "MOP5", "MOP6", "MOP7"};
    
    exp.paretoFrontFile_ = new String[]{"MOP1.dat", "MOP2.dat", "MOP3.dat", 
    		"MOP4.dat", "MOP5.dat", "MOP6.dat", "MOP7.dat"};

    exp.indicatorList_ = new String[]{"HV","IGD"};

    int numberOfAlgorithms = exp.algorithmNameList_.length;

    exp.experimentBaseDirectory_ = "H:/runexperiment/experiment";
    exp.paretoFrontDirectory_ = "H:/runexperiment/trueParetoFront";
  ...
  //  test.executeTest("IGD");
    ...
    problems = new String[]{"MOP1", "MOP2", "MOP3", "MOP4", "MOP5", "MOP6", "MOP7"} ;
